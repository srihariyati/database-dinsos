...
@section('content')
    <div id="card-satu">
            <div id="data" class="row">
                ...
                <div class="col-auto" >
                    <a href="{{ url('/tambahdtks')}}" id="tambah" class="tombol btn-group text-white fw-bold form-control btn-lg mt-3" style="background-color: #1CCE2E; text-decoration: none; padding:1vh;"> Tambah </a>
                </div>
